package token;
/**
 * Classe di enumerativi che rappresenta i possibili tipi di Token riconoscibili dal compilatore.
...
public enum TokenType {
	 ...
	 * */
	TYINT,
	/** enumerativo che indica la stampa
	 * */
	PRINT,
	/** enumerativo che indica un identificatore
	 * */
	ID,
