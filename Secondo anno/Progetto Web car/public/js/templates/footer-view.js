...
function creaFooter() {
    return`
    <nav class="navbar navbar-expand-lg style-footer mt-5">
    <div class="container-fluid container-fluid-center-element">
        <div class="row">
            <div class="col-sm-12">
                ...
                <br> <br>
                <p class="text-center"><strong>Contattaci</strong><br></p>
                <p class="text-center">Relazione con i clienti - 0123456789<br></p>
                <p class="text-center">Email: info@RicaricaVeicoliElettrici.com <br></p>
